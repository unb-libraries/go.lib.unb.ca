...
This repository contains the assets used to test, build, and deploy the go.lib.unb.ca application.
...
- Consequently, the contents of this repository [unb-libraries/go.lib.unb.ca] are licensed under the [MIT License](http://opensource.org/licenses/mit-license.html). This license explicitly excludes:
